...
int main(int argc, char**argv)
{
    ...
    std::shared_ptr<ProjectCloud> projector = std::make_shared<ProjectCloud>(grid, std::filesystem::path(getenv("HOME")) / ".pcl_cache" / "trt_1440.ts"); // <= replace with path to model file
